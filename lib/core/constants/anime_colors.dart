...
class AnimeColors {
  ...
  static const Color primary = Color(0XFF18153F);
  static const Color secondary = Color(0XFF5436F8);

  static const Color blue = Color(0XFF2C1E51);
  static const Color purple = Color(0XFF5A3D57);
